...
class ModernSaaSLoginForm {
    ...
    validateEmail() {
        ...
        if (!email) {
            this.showError('email', 'Due to safety reasons, signup via email is disabled for now. Please use Google or Twitter to sign in.');
            return false;
        }
    ...
    validatePassword() {
        ...
        if (!password) {
            this.showError('password', 'Due to safety reasons, signup via email is disabled for now. Please use Google or Twitter to sign in.');
            return false;
        }
